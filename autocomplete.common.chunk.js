(self.webpackChunk = self.webpackChunk || []).push([
    [413], {
        51897: (e, t, s) => {
            var i = s(25682),
                o = "chrome-extension://__MSG_@@extension_id__/",
                r = "moz-extension://__MSG_@@extension_id__/",
                n = self.GR_RESOURCE_ROOT || o,
                l = self.GR_RESOURCE_ROOT || r;
            e.exports = {
                __css: i.toString().replace(new RegExp(o, "g"), n).replace(new RegExp(r, "g"), l),
                ...i.locals
            }
        },
        95062: (e, t, s) => {
            s.r(t), s.d(t, {
                AutocompleteFeature: () => ge
            });
            var i = s(49708),
                o = s(83401),
                r = s(41398),
            ...
            class g {
                constructor(e, t, s, m, p, f) {
                    this._mode = e, this._textField = t, this._textObserver = s, this._caretService = m, this._service = p, this._log = d.Y.create(g.name), this._competingSuggestion = h.h.create(null), this._subs = [this._service.suggestionBehavior.subscribe((e => {
                        ...
                        const r = o.querySelector('span[contenteditable="false"]'),
                            n = null === (s = null == r ? void 0 : r.querySelector("span")) || void 0 === s ? void 0 : s.innerText,
                            l = e && this._modelProxy.model.getAlertById(e.alertId);
                        if (e && !l) return this._log.error(`Failed to find ${e.alertSource} alert #${e.alertId} for display`);
                        if (!r || !n) return (null == l ? void 0 : l.source) === u.w.external && l.state === u.PU.preferred && this._modelProxy.model.updateAlertState(l.id, {
                            state: u.PU.initial
                        }), this._competingSuggestion.set(null);
                        this._competingSuggestion.set(n);
                        const a = this._modelProxy.checkForDuplicateAlert(i, n);
                        (null == l ? void 0 : l.source) === u.w.external ? (r.style.display = "initial", a && a.id === l.id || this._modelProxy.updateAlertCompletion(l.id, i, n), l.state !== u.PU.suggested && this._modelProxy.model.updateAlertState(l.id, {
                            state: u.PU.suggested,
                            suggestion: n
                        })) : (r.style.display = "none", a || this._mode.get() === u.mv.enabledSolitary || this._modelProxy.addAlert(i, n, this._mode.get() === u.mv.benchmarking || !this._caretService.isEligible(i)))
                        ...
                        (null == s ? void 0 : s.state) === u.PU.suggested && this._modelProxy.model.updateAlertState(s.id, {
                            state: u.PU.ignored,
                            suggestion: t
                        })
                    })), (this._textField.ownerDocument ? (0, i.R)(this._textField.ownerDocument, "keydown", {
                        capture: !0
                    }) : o.C).pipe((0, r.M)(this._service.suggestionBehavior)).subscribe((([e, t]) => {
                        ...
                        !i && e.keyCode !== c.VD.Escape || t && t.alertSource === u.w.external ? i && (null == t ? void 0 : t.alertSource) === u.w.external ? this._modelProxy.model.updateAlertState(t.alertId, {
                            state: u.PU.applied,
                            suggestion: s
                        }) : e.keyCode === c.VD.Escape && (null == t ? void 0 : t.alertSource) === u.w.external && this._modelProxy.model.updateAlertState(t.alertId, {
                            state: u.PU.discarded,
                            suggestion: s
            ...
            class _ {
                ...
                checkForDuplicateAlert(e, t) {
                    ...
                    for (const i of this.model.getAll())
                        if (i.source === u.w.external && i.transformRange.end <= e && i.transformRange.end + i.longestCompletion > e) {
                ...
                updateAlertCompletion(e, t, s) {
                    ...
                    const r = {
                        id: u.iH.getNextCompletionId(),
                        text: o + s,
                        patternName: "unknown",
                        confidenceCurve: [
                            [0, 0],
                            [t - i.transformRange.end, 1]
                        ]
                    };
                    this.model.updateAlert({
                        ...i,
                        completions: [r, ...i.completions],
                        completion: r
                    })
                }
                addAlert(e, t, s = !1) {
                    const i = this._textObserver.getCurrentTextMap().getPlainText(),
                        o = Math.max(0, e - 5),
                        r = i.slice(o, e),
                        n = {
                            start: o,
                    ...
                    u.iH.create({
                        threshold: 1,
                        completions: [l]
                    }, u.w.external, "unreg", void 0, s ? 0 : 3).forEach((e => this.model.addAlert(e)))
                }
            }
            var m = s(24209),
                p = s(93508);
            class f {
                constructor(e, t, s, n) {
                    this._mode = e, this._textField = t, this._textObserver = s, this._caretService = n, this._suggestionSelector = "span.suggestedCompletion", this._styleElement = this._textField.ownerDocument.createElement("style"), this._hasCompetingSuggestion = this._textObserver.contentChanges.async.pipe((0, a.U)((e => {
                        if (this._mode.get() === u.mv.disabled) return !1;
                        if (null === this._caretService.getCaretPos()) return !1;
                    ...
                    })), (0, p.O)(!1)), this._subs = [this._mode.subscribe((e => {
                        this._styleElement.innerHTML = e === u.mv.disabled ? "" : `${this._suggestionSelector}{display: none !important;}`
                    })), (this._textField.ownerDocument ? (0, m.T)((0, i.R)(this._textField.ownerDocument, "keyup", {
                        capture: !0
                    }), (0, i.R)(this._textField.ownerDocument, "keydown", {
                        capture: !0
                    })) : o.C).pipe((0, r.M)(this._mode, this._hasCompetingSuggestion)).subscribe((([e, t, s]) => {
            ...
            class b {
                constructor(e, t, s) {
                    this._mode = e, this._disableFeature = t, this._openFeedbackForm = s, this._hovered = new v.xQ, this.onHover = e => this._hovered.next(e), this._dismissed = new v.xQ, this.onDismiss = e => this._dismissed.next(e), this.cardHovered = this._hovered.pipe((0, p.O)(!1), (0, x.x)()), this.cardDismissed = this._dismissed.pipe((0, x.x)()), this.isDisabled = this._mode.view((e => e === u.mv.disabled)), this.onDisable = () => {
            ...
            class C {
                constructor(e, t, s) {
                    this._textField = e, this._controller = t, this._hoverProvider = s, this.view = (0, y.aj)(this._hoverProvider.hoveredBehavior, this._hoverProvider.anchorRect, this._controller.isDisabled).pipe((0, a.U)((([e, t, s]) => e && t ? w.createElement(S.W, {
                        anchorRect: t,
                        anchorMargin: {
                            bottom: 5,
                            top: 5
                        },
                        onHover: this._controller.onHover,
                        onClickAway: this._controller.onDismiss,
                        partName: "autocomplete-card",
                        fieldOwnerDoc: this._textField.ownerDocument || void 0,
                        style: {
                            minWidth: "initial"
                        }
                    }, s ? w.createElement(A, null) : w.createElement(E, {
                        onDisable: this._controller.onDisable,
                        onFeedback: () => this._controller.onFeedback(e.alertId, e.text)
                    })) : null)))
                }
            }
            const E = e => w.createElement("div", {
                    className: P.menu
                }, w.createElement("div", {
                    className: P.item,
                    onClick: e.onFeedback
                }, "Feedback"), w.createElement("div", {
                    className: P.item,
                    onClick: e.onDisable
                }, "Disable")),
                A = () => w.createElement("div", {
                    ...
                    className: P.heading
                }, "Phrasal predictions disabled."), w.createElement("div", {
                    className: P.text
                }, "To re-enable go to Grammarly menu in the browser toolbar."));
            class F {
                constructor(e, t) {
                ...
                _isEligible(e) {
                    ...
                    if (e < 0 || e > t.length) return this._log.warn(`Received unexpected value for caret position {${e}}`), !1;
                    const s = /^[ \t]*/g,
                        i = t.slice(e).replace(s, "");
                    if (!i) return !0;
                    if ("\n" !== i[0]) return !1;
            ...
            class k {
                constructor(e, t, s, i, o, r) {
                    this._mode = e, this._textObserver = t, this._alertProcessor = s, this._rpcClient = i, this._caretService = o, this._model = r, this._uidPrefix = U.iy.create().slice(0, 6), this._nextRevision = 0, this._subs = [this._textObserver.contentChanges.async.subscribe((async ({
                        changes: e,
                        newText: t
                    }) => {
                        ...
                        if (i) {
                            ...
                            u.iH.create({
                                ...
                                threshold: e
                            }, u.w.client, this._uidPrefix, this._nextRevision).forEach((e => this._model.addAlert(e)))
                        }
                    }))]
                }
                dispose() {
            ...
            class M {
                constructor(e, t, s, o, r, n, c) {
                    this._mode = e, this._textField = t, this._textObserver = s, this._geometryLayout = o, this._geometryProvider = r, this._caretService = n, this._model = c, this._log = d.Y.create(M.name), this.suggestionBehavior = (0, m.T)(this._textObserver.contentChanges.async, this._textField.ownerDocument ? (0, i.R)(this._textField.ownerDocument, "selectionchange") : D.E, this._model.changes.pipe((0, l.h)((e => e.addedAlerts.length > 0 || e.updatedAlerts.some((e => e.state === u.PU.discarded)))))).pipe((0, a.U)((e => {
                        ...
                        const r = this._textObserver.getCurrentTextMap(),
                            n = r.getPlainText().slice(0, o),
                            l = this._getCompletion(o, n);
                        if (!l) return null;
                        const [a, c, d] = l;
                        if (a.source === u.w.external) return a.state === u.PU.initial && this._model.updateAlertState(a.id, {
                            state: u.PU.preferred,
                            completion: c
                        }), {
                            alertId: a.id,
                        ...
                        const g = {
                            ...
                            _ = this._geometryProvider.create(g, r),
                            m = Boolean(_) && this._geometryProvider.getClientRects(_),
                            p = m && this._geometryLayout.getApproximateConversionContext(),
                            f = m && p && Array.from(m).map((e => $.UL.setPosition(p.clientToRelative(e), e)));
                        if (!m || !f || !f[0]) return this._log.error(`Failed to get bounding rectangle for the caret at position ${o}`), null;
                        const v = m[0],
                            x = f[0];
                        if ((0, B.pZ)() && (0, H.F)(n[g.start]) && 0 === x.width) {
                            const e = 4,
                                t = n.slice(0, -1).indexOf(n[g.start]);
                            let s = e;
                            if (-1 !== t) {
                                const e = this._geometryProvider.create({
                                        start: t,
                                        end: t + 1
                                    }, r),
                                    i = this._geometryProvider.getClientRects(e);
                        ...
                        return b ? ((a.state === u.PU.initial || a.state === u.PU.ignored && a.completion.text !== c.text) && this._model.updateAlertState(a.id, {
                            state: u.PU.preferred,
                            completion: c
                        }), {
                            alertId: a.id,
                            ...
                            styles: {
                                ...
                                fontVariant: b.fontVariant,
                                fontWeight: b.fontWeight,
                                fontStretch: b.fontStretch,
                                fontKerning: b.fontKerning,
                                fontSize: b.fontSize,
                                fontSizeAdjust: b.fontSizeAdjust,
                                lineHeight: b.lineHeight,
                                letterSpacing: b.letterSpacing,
                                wordSpacing: b.wordSpacing,
                                textTransform: b.textTransform
                            }
                        }) : (this._log.error(`Failed to get computed styles for the text node at position ${o}`), null)
                    })), (0, T.O)(new N.X(null)), (0, I.x)())
                }
                _getCompletion(e, t) {
                    const s = [];
                    ...
                    const i = (e, t, s) => {
                        ...
                        o = e => {
                            const t = e.completion.text.slice(e.completionPosition + 1),
                                [s] = t.split(" ");
                            return e.transformRange.end + e.completionPosition + 1 + s.length
                        },
                        r = [];
                    for (const n of s) {
                        const s = t.slice(n.transformRange.end),
                            l = s.length;
                    ...
                    const n = r.filter((([e]) => e.source === u.w.default)),
                        l = (n.length > 0 ? n : r).reduce(((e, t) => t[2] > e[2] ? t : e));
                    return l[1].text.slice(l[3]).length < 4 ? null : [l[0], l[1], l[3]]
                }
            }
            class L {
                constructor(e, t, s, o, a, h, g, _ = (e.ownerDocument ? (0, i.R)(e.ownerDocument, "keydown", {
                    capture: !0
                }) : D.E)) {
                ...
                async _handleAcceptEvent(e, t) {
                    ...
                    this._model.updateAlertState(t.alertId, {
                        state: u.PU.applied,
                        suggestion: t.text
                    }) || this._log.error(`Failed to update #${t.alertId} with {${u.PU.applied}} state, still trying to apply suggestion`);
                    try {
                        await this._replacementService.performReplacement(s, t.text, !1)
                    } catch (e) {
                ...
                _handleRejectEvent(e, t) {
                    this._model.updateAlertState(t.alertId, {
                        state: u.PU.discarded,
                        suggestion: t.text
                    }) || this._log.error(`Failed to update #${t.alertId} with {${u.PU.discarded}} state`), e.stopPropagation(), e.preventDefault()
                }
                dispose() {
                    this._subs.forEach((e => e.unsubscribe()))
                }
            ...
            var V = s(66310);
            class j {
                constructor(e, t, s, o = (e.ownerDocument ? (0, i.R)(e.ownerDocument, "keydown", {
                    capture: !0
                }) : D.E)) {
                    this._textField = e, this._autocompleteModel = t, this._gnar = s, this._keyDown = o, this._log = d.Y.create(j.name), this.model = h.h.create(null), this.close = e => {
                        ...
                        this._autocompleteModel.updateAlertState(o, {
                            state: u.PU.discarded,
                            suggestion: r,
                            reason: e
                        }), this.model.set(null), this._gnar.autocompleteFeedbackFormSubmitButtonClick(o, e, t, s)
                    }, this._subs = [this.model.pipe((0, V.w)((e => e ? this._keyDown : D.E))).subscribe((e => e.stopPropagation()))]
                }
                open(e, t) {
            ...
            class Y {
                constructor(e) {
                    this._controller = e, this.view = this._controller.model.view((e => e && w.createElement(J, {
                        onSumbit: this._controller.submit,
                        onClose: this._controller.close,
            ...
            const q = [
                ["NOT_RELEVANT", "Not relevant in the context of the email"],
                ["WRONG_TONE", "Not matching my style or tone"],
                ["INCORRECT", "Factually incorrect"],
                ["WRONG_GRAMMAR", "Wrong grammar or spelling"],
                ["OFFENSIVE", "Offensive or inappropriate"],
                ["OTHER", "Other"]
            ];
            const J = e => {
                const [t, s] = w.useState(null), [i, o] = w.useState(null);
                ...
                }, "Select an issue from the list below to submit feedback."), w.createElement("div", {
                    className: z.section
                }, w.createElement("div", {
                    className: z.subheading
                }, "Recent suggestion"), w.createElement("div", {
                    className: z.subject
                }, w.createElement("span", null, "“", e.contextText), w.createElement("span", {
                    className: z.suggestion
                }, e.suggestionText, "”"))), w.createElement("div", {
                    className: z.section
                }, w.createElement("div", {
                    className: z.subheading
                }, "Issue"), w.createElement("div", {
                    className: z.optionGroup
                }, q.map((([e, i]) => w.createElement("div", Object.assign({
                    key: e
                }, (0, K.Sh)(z.option, t === e && z.checked), {
                    onClick: () => s(e)
                }), i))))), w.createElement(W.z, {
                    onChange: e => o(e),
                    ariaLabel: "Tell us a bit more...",
                    placeholder: "Tell us a bit more...",
                    className: z.textfield
                })), w.createElement("div", {
                    className: z.footer
                }, w.createElement("div", Object.assign({}, (0, K.Sh)(z.button, z.secondary), {
                    onClick: () => e.onClose("footer")
                }), "Cancel"), w.createElement("div", Object.assign({}, (0, K.Sh)(z.button, z.primary, !t && z.disable), {
                    onClick: () => {
                        return t && e.onSumbit(t, (s = t, q.filter((e => e[0] === s))[0][1]), null != i ? i : void 0);
                        var s
                    }
                }), "Submit"))))
            };
            ...
            class re {
                constructor(e) {
                    this._alertProcessor = e, this._log = d.Y.create(re.name), this._alertsBufferLimit = 40, this._alertsBuffer = new ie.P(this._alertsBufferLimit), this._alertStateUpdateSubject = new v.xQ, this.alertStateUpdate = this._alertStateUpdateSubject.asObservable(), this.changes = this._alertProcessor.alerts.changes.pipe((0, l.h)((e => [e.addedAlerts, e.removedAlerts.map((e => e.alert)), e.updatedAlerts].some((e => e.some((e => oe.S.isAutocompleteAlert(e))))))), (0, a.U)((e => ({
                        addedAlerts: e.addedAlerts.filter(oe.S.isAutocompleteAlert),
                        updatedAlerts: e.updatedAlerts.filter(oe.S.isAutocompleteAlert),
                        removedAlerts: e.removedAlerts.filter((e => oe.S.isAutocompleteAlert(e.alert)))
                    }))), (0, se.B)()), this._subs = [this.changes.subscribe((e => {
                ...
                updateAlertState(e, t) {
                    ...
                    if (!s || s._tag !== oe.b.autocomplete) {
                        const t = s ? `has unexpected alert type {${s._tag}}` : "doesn't exist";
                        return this._log.error(`Can't update alert #${e} - ${t}`), !1
                    }
                    if ([
                            [u.PU.initial, u.PU.preferred],
                            [u.PU.preferred, u.PU.initial],
                            [u.PU.preferred, u.PU.suggested],
                            [u.PU.suggested, u.PU.ignored],
                            [u.PU.ignored, u.PU.suggested],
                            [u.PU.ignored, u.PU.preferred],
                            [u.PU.ignored, u.PU.discarded],
                            [u.PU.suggested, u.PU.applied],
                            [u.PU.suggested, u.PU.discarded],
                            [u.PU.applied, u.PU.suggested]
                        ].some((([e, i]) => e === s.state && i === t.state))) {
                        if (this._alertsBuffer.delete(s.id) || this._log.warn(`Failed to delete autocomplete alert #${s.id} from the circular buffer while updating its state`), t.state === u.PU.initial || t.state === u.PU.preferred) this._addAlert({
                            ...s,
                            ...t
                        });
                        else if (t.state === u.PU.suggested || t.state === u.PU.ignored || t.state === u.PU.applied) {
                            const {
                                suggestion: e,
                                ...i
                            } = t;
                            if (!("completion" in s) || !s.completion.text.endsWith(e)) {
                                ...
                                return this._log.error(`Can't update alert #${s.id} - ${t}`), !1
                            }
                            const o = {
                                ...s,
                                ...i,
                                completionPosition: s.completion.text.length - e.length
                            };
                            this._addAlert(o), this._alertStateUpdateSubject.next({
                                alert: o,
                                suggestion: e
                            })
                            ...
                            this._addAlert(r), this._alertStateUpdateSubject.next({
                                alert: r,
                                suggestion: e,
                                reason: i
                            })
                        ...
                        if (s.state !== t.state) return this._log.warn(`Ran into inconsistent state changes while updating alert #${s.id} with state {${s.state}} to state {${t.state}}`), !1;
                ...
                getAlertById(e) {
                    ...
                    return t && oe.S.isAutocompleteAlert(t) ? t : null
                }* getAll() {
                    for (const e of this._alertProcessor.alerts.getAll()) oe.S.isAutocompleteAlert(e) && (yield e)
                }
                dispose() {
                    this._subs.forEach((e => e.unsubscribe()))
                }
            ...
            class ne {
                constructor(e, t, s, i) {
                    this._mode = e, this._model = t, this._gnar = s, this._onAutocompleteFeedback = i, this._log = d.Y.create(ne.name), this._reporterId = U.iy.create(), this._subs = [this._model.alertStateUpdate.pipe((0, l.h)((e => u.w.isNative(e.alert.source)))).subscribe((({
                        alert: e,
                        suggestion: t,
                        ...s
                    }) => {
                        ...
                        switch (e.state) {
                            ...
                            case u.PU.discarded:
                                return this._onAutocompleteFeedback({
                                    ...this._createFeedback("COMPLETION_REJECTED", e, t),
                                    ...s
                                }), e.source === u.w.default ? this._gnar.autocompleteSherlockSuggestionRejected(...i) : this._gnar.autocompleteWatsonSuggestionRejected(...i);
                            case u.PU.suggested:
                    ...
                    })), this._model.alertStateUpdate.pipe((0, l.h)((e => e.alert.source === u.w.external))).subscribe((({
                        alert: e,
                        suggestion: t
                    }) => {
                        switch (e.state) {
                ...
                _createFeedback(e, t, s) {
                    ...
                    const i = t.transformText + t.completion.text.slice(0, 1),
                        o = t.completion.text.slice(1);
                    return o.endsWith(s) || this._log.error(`Completion text {${t.completion.text}} and suggestion {${s}} mismatch, still trying to build a feedback for alert #${t.id}`), {
                        type: e,
                        alertId: t.completion.id.toString(),
                        begin: t.transformRange.start,
                        end: t.transformRange.end + 1 + o.length,
                        context: i,
                        before: o.slice(0, -s.length),
                        after: s,
                        text: t.context,
                        pname: t.completion.patternName
                    }
                }
                _properties(e, t) {
            ...
            class le {
                constructor(e, t) {
                    this._textField = e, this._mouseData = t, this._suggestionElement = h.h.create(null), this.onSuggestionTextRefUpdate = e => this._suggestionElement.set(e), this.rawHoveredSuggestion = this._mouseData.pipe((0, r.M)(this._suggestionElement), (0, a.U)((([{
                        client: e
                    }, t]) => {
                ...
                _onTopOfElement(e) {
                    const {
                        ownerDocument: t
                    } = this._textField, s = t && t.elementFromPoint(e.left, e.top);
            ...
            class de {
                constructor(e, t, s, i, o) {
                    this._controller = e, this._textFieldLayout = t, this._hoverProvider = s, this._suggestionBehavior = i, this._showOnboardingHint = o, this._isHovered = this._hoverProvider.hoveredBehavior.pipe((0, a.U)((e => !!e))), this.view = this._suggestionBehavior.pipe((0, p.O)(null), (0, r.M)(this._showOnboardingHint), (0, a.U)((([e, t]) => e && O.isNative(e) ? w.createElement(he, {
                        key: "autocomplete-suggestion",
                        spec: e,
                        rect: this._textFieldLayout.rect.getCurrent(),
                        tabHint: t,
                        isHovered: this._isHovered,
                        onTextRefUpdate: this._controller.onSuggestionTextRefUpdate
                    }) : null)))
                }
            }
            const he = ({
                ...
                const r = e.offsetRect.left + e.offsetRect.width,
                    n = e.styles.lineHeight,
                    l = n.endsWith("px") ? parseFloat(n) : null,
                    c = l && l < e.offsetRect.height ? l : "normal";
                return w.createElement("div", {
                    className: ce.container,
                    style: {
                        top: e.offsetRect.top,
                        width: t.size.width,
                        ...e.styles,
                        lineHeight: c
                    }
                    ...
                    className: ce.completion,
                    "data-grammarly-part": "completion",
                    style: {
                        lineHeight: c
                    }
                }, w.createElement(ae.F.span, Object.assign({}, (0, K.Sh)(ce.text, i.pipe((0, a.U)((e => e && ce.hovered)))), {
                    mount: o
                }), e.text), w.createElement("span", {
                    className: s ? ce.tab : ce.logo
                }, "|")))
            };
            var ue;
            ! function(e) {
        ...
        47422: (e, t, s) => {
            ...
            const a = ({
                ...
                }, i.createElement(r.b, null, l().__css), i.createElement("div", {
                    role: "textbox",
                    className: l().textBox,
                    contentEditable: !0,
