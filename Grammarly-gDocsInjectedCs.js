...
class n {
    constructor(e, t, n, o, r = e.defaultView || e) {
        this._inboundEventName = t, this._outboundEventName = n, this._api = o, this._target = r, this._handleInbound = ({
            detail: e
        }) => {
            const t = e;
            try {
                ...
                if ("function" != typeof e) throw {
                    message: `invalid method name ${t.method}`
                }; {
    ...
    _outbound(e) {
        const t = new CustomEvent(this._outboundEventName, {
            bubbles: !0,
            cancelable: !0,
            detail: e
        });
...
function o(e, t) {
    ...
    function i(e, t, n, o = Object.getOwnPropertyNames(e)) {
        ...
        const l = (o, c, u, d = 0) => {
            ...
            var p;
            if (null != c && !i.has(c))
                if (i.add(c), Array.isArray(c)) c.forEach(((e, t) => {
                    try {
    ...
    function a(e, t) {
        ...
        })(r.results, (e => e.value)).filter((e => e.value !== l)).filter((e => !e.path.some((e => e.includes("font-size")))));
    ...
    const l = ["autocorrect", "comment", "composing_decoration", "composing_region", "draft_comment", "ignore_spellcheck", "ignore_word", "import_warnings", "link", "named_range", "revision_diff", "smart_todo", "spellcheck", "suppress_feature", "text", "voice_corrections", "voice_dotted_span", "autogen", "cell", "citation_sources", "column_sector", "date_time", "document", "equation", "equation_function", "footnote", "headings", "horizontal_rule", "language", "list", "paragraph", "row", "tbl"];

    function c(e) {
        const t = u(e).map((e => s(e))).find((e => e.length > 20));
    ...
    const d = new class {
            ...
            _extractGetTextFn() {
                try {
                    ...
                    if (null !== e) {
                        ...
                        if (t.length > 0) {
                            const {
                                suggestionsFullArrayPath: e,
                                suggestionFastArrayPath: s
                            } = function(e, t) {
                                try {
                                    const n = o(Object.getOwnPropertyNames(e).find((e => -1 !== e.toString().indexOf("_kixApp")))),
                                        r = i(o(e[n], "kixApp"), ((e, t) => t && Array.isArray(t) && t.some((e => Array.isArray(e) && -1 !== e.toString().indexOf("suggest.")))), 10).results.filter((e => e.path[0] === t[1])).filter((e => !l.some((t => e.path.includes(t))))).map((e => {
                                            const t = [...e.path];
                                            return t.pop(), t
                                        })).reduce(((t, o) => {
                                            const r = [n].concat(o).reduce(((e, t) => e[t]), e);
                                            return t ? r[t.idProp] > t.id ? {
                                                ...t,
                                                id: r[t.idProp],
                                                path: o
                                            } : t : Object.getOwnPropertyNames(r).reduce(((e, t) => Array.isArray(r[t]) || isNaN(parseInt(r[t], 10)) ? Array.isArray(r[t][0]) ? {
                                                ...e,
                                                fullArrayProp: t
                                            } : {
                                                ...e,
                                    ...
                                    return {
                                        suggestionFastArrayPath: r ? [n].concat(r.path, r.compactArrayProp) : null,
                                        suggestionsFullArrayPath: r ? [n].concat(r.path, r.fullArrayProp) : null
                                    }
                                } catch (e) {
                                    return {
                                        suggestionFastArrayPath: null,
                                        suggestionsFullArrayPath: null
                                    }
                                }
                            }(this._win, t), a = Array.isArray(e) && e.pop(), c = Array.isArray(s) && s.pop(), u = e && e.reduce(((e, t) => e[t]), this._win);
                            return {
                                getText: () => {
                                    const e = r[n],
                                        t = u && a && u[a],
            ...
            _getText(e) {
                try {
                    return this._getTextFn || (this._getTextFn = this._extractGetTextFn()), e.reQueryForIgnoredRanges && "gotIgnoredRanges" in this._getTextFn && !this._getTextFn.gotIgnoredRanges && (this._getTextFn = this._extractGetTextFn()), "getText" in this._getTextFn ? this._getTextFn.getText() : "noSubText" === this._getTextFn.error ? (this._getTextFn = null, null) : null
                } catch (e) {
                    return null
                }
            }
